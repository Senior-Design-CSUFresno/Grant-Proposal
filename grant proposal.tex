...
\end{table}
	...
	\hspace*{0mm}\phantom{Approved: }Heather Libecki\\
	\hspace*{0mm}\phantom{Approved: }Project Manager
	
	Approved: \hrulefill
	
	\hspace*{0mm}\phantom{Approved: }Chris Quesada\\
	\hspace*{0mm}\phantom{Approved: }team member
	
	Approved: \hrulefill
	
	\hspace*{0mm}\phantom{Approved: }Juan Colin\\
	\hspace*{0mm}\phantom{Approved: }team member
	\end{flushleft}\par
	\setlength{\parindent}{5ex}
	...
	\hspace*{0mm}\phantom{Approved: }Technical advisor
