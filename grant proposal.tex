...
\begin{document}
	...
	\begin{table} [H]	
		...
		\resizebox{17cm}{!}{
			\begin{tabular}{|c|c|c|}
				\hline
				\textbf{Member Assign.} & \textbf{Start-End Date} & \textbf{Description} \\
				\hline
	...
	\end{table}
		...
		\resizebox{17cm}{!}{
			\begin{tabular}{|c|c|c|}
				...
				\hline
					Chris Q. & 11/15-11/25/18 & Test the microcontroller after researching the ports needed for the project.\\
				\hline
...
\begin{table} [H]	
	...
	\resizebox{17cm}{!}{
		\begin{tabular}{|c|c|c|}
			\hline
			\textbf{Member Assignment} & \textbf{Start-End Date} & \textbf{Description} \\
			\hline
				Chris Q. & 1/1-1/20/19 & Develop the code for the image processing program. \\
			\hline
				Juan C. & 1/1-1/15/19 & Configure the power system for the mechanical parts of the Smart Eraser. \\
			\hline
			...
			\hline
				Heather \& Chris & 1/15-1/30/19 & Develop the algorithm to determine the quickest path to erase markings on the board.\\
			\hline
			...
			\hline
				All & 3/26-4/15/19 & Integrate the motion-detecting program with the camera and microcontroller-mechanical system.\\
			\hline
